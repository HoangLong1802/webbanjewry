...
class Payment extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      activeStep: 1 // 1: Shipping Info, 2: Payment Info
    };
  }
  ...
  componentDidMount() {
    ...
    // Load customer address if available
    if (this.context.customer && this.context.customer.address) {
      this.setState({
        shippingAddress: {
  ...
  validateForm = () => {
    const errors = {};
    const { cardNumber, expiryDate, cvv, cardholderName } = this.state;
