...
class Main extends Component {
  ...
  lnkLogoutClick() {
    ...
    // Also clear localStorage manually to ensure complete logout
...
const MainWithLanguage = ({ username, onLogout }) => {
  ...
  const notifications = [
    { id: 1, type: 'order', message: 'New order #12345 received', time: '2 minutes ago', unread: true },
    { id: 2, type: 'user', message: 'New customer registered: John Doe', time: '5 minutes ago', unread: true },
    { id: 3, type: 'order', message: 'Order #12344 completed', time: '1 hour ago', unread: false },
    { id: 4, type: 'user', message: 'Customer updated profile: Jane Smith', time: '2 hours ago', unread: false }
  ];
                ...
                <div className="user-dropdown">
                  <div className="user-dropdown-header">
                    ...
                    <div className="user-details">
                      ...
                      <span className="user-role-large">{t('administrator')}</span>
                    </div>
                  </div>
