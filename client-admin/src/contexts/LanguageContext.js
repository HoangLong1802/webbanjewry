...
const translations = {
  ...
  ja: {
    ...
    customers_found: "顧客が見つかりました",
    loading_customers: "顧客を読み込み中...",
    no_customers_found: "顧客が見つかりません",
    view_customer_orders: "注文を表示",
    deactivate_customer: "顧客を無効化",
    activate_customer: "顧客を有効化",
    send_email: "メール送信",
    customer_status_active: "アクティブ",
    customer_status_inactive: "非アクティブ",
    ...
    search_orders: "注文を検索...",
    orders_found: "注文が見つかりました",
    loading_orders: "注文を読み込み中...",
    no_orders_found: "注文が見つかりません",
    update_order_status: "注文ステータス更新",
